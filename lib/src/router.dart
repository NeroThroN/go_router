...
class GoRouter extends ChangeNotifier with NavigatorObserver {
  ...
  GoRouter({
    ...
    final RouteMatcher matcher = RouteMatcher(_routeConfiguration);
    final RouteMatchList? matches =
        initialLocation != null ? matcher.findMatch(initialLocation) : null;
    ...
    _routerDelegate = GoRouterDelegate(
      ...
      initialMatch:
          matches?.isNotEmpty ?? false ? matches?.matches.first : null,
